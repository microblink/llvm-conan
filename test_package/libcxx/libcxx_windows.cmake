...
if ( MSVC )
    ...
    add_link_options( ${llvm_root}/lib/libc++.lib ${llvm_root}/lib/clang/${CMAKE_CXX_COMPILER_VERSION}/lib/windows/clang_rt.builtins-${suffix}.lib vcruntime.lib msvcprt.lib )
else()
